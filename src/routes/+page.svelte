...
<div class="app w-full h-full flex items-center justify-center">
    <div class="app-content py-5 px-8 rounded-xl border-2 transition-all duration-200 bg-opacity-15 bg-black">
        ...
        {:else}                
            <div class="app-ai-bar flex items-center justify-between rounded-full w-full bg-[#27272a] mb-6 transition-all duration-200 hover:shadow-blue-600 hover:shadow-sm" transition:fade>
                ...
                {#if question.length > 1} 
                    <div class="go-arrow p-2 rounded-full hover:bg-[#18181bab] cursor-pointer transition-all duration-200 mr-0.5">
            ...
            <div class="legal flex justify-center items-center gap-4 cursor-pointer mb-5" transition:fade>
